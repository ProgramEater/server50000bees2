...
public class App {
    public static void main(String[] args) {
        ...
        if (!(authorityRepository.findByAuthority("ROLE_ADMIN").isPresent())) {authorityRepository.save(new Authority("ROLE_ADMIN"));}
        if (!(authorityRepository.findByAuthority("ROLE_USER").isPresent())) {authorityRepository.save(new Authority("ROLE_USER"));}
